...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-gray-400 p-2 w-full" type="text" name="slug" id="slug" value="<?php echo e(old('slug')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea class="border border-gray-400 p-2 w-full" name="excerpt" id="excerpt" required><?php echo e(old('excerpt')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-6">
                    ...
                    <textarea class="border border-gray-400 p-2 w-full" name="body" id="body" required><?php echo e(old('body')); ?></textarea>

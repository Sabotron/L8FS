...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.post_featured_card','data' => ['post' => $posts[0]]]); ?>
<?php $component->withName('post_featured_card'); ?>
...
<div class="lg:grid lg:grid-cols-6">
    ...
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.post_card','data' => ['post' => $post,'class' => ''.e($loop->iteration < 3 ? 'col-span-3' : 'col-span-2').'']]); ?>
<?php $component->withName('post_card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?><?php /**PATH /home/vagrant/sites/lfts.isw811.xyz/resources/views/components/posts_grid.blade.php ENDPATH**/ ?>
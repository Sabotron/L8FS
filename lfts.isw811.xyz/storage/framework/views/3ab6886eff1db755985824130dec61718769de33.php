...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('trigger', null, []); ?> 
        ...
        <button class="py-2 pl-3 pr-9 text-sm font-semibold w-full lg:w-32 text-left lg:inline-flex">
            ...
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.icon','data' => ['name' => 'down_arrow','class' => 'absolute pointer-events-none','style' => 'right:12px;']]); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['name' => 'down_arrow','class' => 'absolute pointer-events-none','style' => 'right:12px;']); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/vagrant/sites/lfts.isw811.xyz/resources/views/components/category-dropdown.blade.php ENDPATH**/ ?>
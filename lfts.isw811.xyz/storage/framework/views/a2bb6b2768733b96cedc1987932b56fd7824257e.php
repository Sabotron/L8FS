        ...
        <div class="flex-1 flex flex-col justify-between">
            ...
            <footer class="flex justify-between items-center mt-8">
                ...
                <div class="hidden lg:block">
                    <a href="/posts/<?php echo e($post->slug); ?>" class="transition-colors duration-300 text-xs font-semibold bg-gray-200 hover:bg-gray-300 rounded-full py-2 px-8">Read More</a>
                </div>
            </footer>
        </div>
    </div>
</article><?php /**PATH /home/vagrant/sites/lfts.isw811.xyz/resources/views/components/post_featured_card.blade.php ENDPATH**/ ?>